...
This directory contains the versioned prompt files used throughout the development of AI-powered applications in this repository.

Prompt engineering is not a one-shot activity. It is an iterative process that directly impacts model performance, output quality, reproducibility, and system behavior. Treating prompts as first-class artifacts is essential for maintaining consistency and traceability over time.
