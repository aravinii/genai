...
As a capstone project, I developed an AI agent focused on the São Paulo real estate market. The agent is designed to help users:
	...
	•	Interpret the current market conditions
	•	Estimate the price of a potential property

Users provide descriptive information about a property, and the agent returns a price estimate along with contextual insights. The goal was to combine generative reasoning with structured information to create a practical, user-oriented application.

This repository serves both as a structured learning record and as an applied experimentation lab for Generative AI systems.
